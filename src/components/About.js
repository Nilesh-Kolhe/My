    ...
    return (
        <div className="about-container">
            <div className='section-headline'>
                About Me <i className="bi bi-file-earmark-person"></i>
            </div>
            <hr />
            ...
            That's why I decided to pursue my major in Computer Engineering at the University of Pune along with building my personal online presence.
