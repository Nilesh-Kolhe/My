    ...
    return (
        <div className='skills-container'>
            ...
            <div className="skills-section">
                <div style={{ margin: "5px -10px", backgroundColor: '#000' }}>
                    <div style={{ display: "flex", fontSize: "smaller", color: "#fff" }}>
                        <div style={{ display: "flex", flexWrap: "wrap", margin: "5px 0px" }}>
                ...
                <div style={{ margin: "5px -10px", backgroundColor: '#000' }}>
                    <div style={{ display: "flex", fontSize: "smaller", height: "100%", color: "#fff" }}>
                        <div style={{ display: "flex", flexWrap: "wrap", margin: "5px 0px" }}>
                            <div className="img-container">
